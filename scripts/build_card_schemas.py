...
DISCONTINUED = {
    "린넨펄", "엔틱골드펄", "포레스트그린", "Extra 엠보 270g", "Extra 엠보",
    "엑스트라 엠보", "골드린넨펄", "네추럴린넨펄", "화이트린넨펄",
}
...
CANONICAL_ALIAS_MAP = {
    ...
    "매직콤마 백색": "엑스트라 매트화이트",
    "매직콤마 화이트": "엑스트라 매트화이트",
    # adsland 페이지명 + 용지명 prefix 정리
    "아르떼 울트라화이트": "아르떼",
    "아르미 울트라화이트": "아르떼",
    "아르떼 UW": "아르떼",
    "켄도 화이트": "켄도",
    "올드밀 리싸이클 비앙코": "올드밀 비앙크",
    "베이직 백색": "모조지",
    "베이직": "모조지",
    "화이트모조": "모조지",
    "모조지 백색": "모조지",
    ...
    "띤또레또순백": "엑스트라 띤또레또",
    "띤또레또 백색": "엑스트라 띤또레또",
    # 엑스트라 매쉬멜로우 → 엑스트라 머쉬멜로우
    "엑스트라 매쉬멜로우": "엑스트라 머쉬멜로우",
    "엑스트라 머쉬": "엑스트라 머쉬멜로우",
    "엑스트라 누보": "엑스트라 누브지",
    "엑스트라 누브": "엑스트라 누브지",
    "엑스트라 휘라레(린넨)": "엑스트라 휘라레",
    "엑스트라 매트": "엑스트라 매트화이트",
    "엑스트라 스타": "엑스트라 스타드림",
}
